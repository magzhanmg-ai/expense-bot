...
# ИСПОЛЬЗУЕМ АСИНХРОННЫЙ КЛИЕНТ (исправление зависаний)
...
async def process_ai_response(user_id, text, update):
    ...
    try:
        # ДОБАВЛЕН AWAIT и актуальная версия модели Claude 3.5 Sonnet
    ...
    try:
        ...
        pass # Если не JSON, просто продолжаем
...
if __name__ == "__main__":
    if not TELEGRAM_TOKEN or not ANTHROPIC_API_KEY:
        print("ОШИБКА: Не установлены токены TELEGRAM_TOKEN или ANTHROPIC_API_KEY!")
        exit(1)
